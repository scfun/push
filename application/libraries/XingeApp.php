...
class XingeApp {
	...
	{
		if(!$params['accessId'] || !$params['secretKey']){
	 ...
	 * 安全模式发送
	 */
	public static function PushSafeMode($params,$title,$content,$url){
		$push = new XingeApp($params);
		$mess = new Message();
		$mess->setTitle($title);
		$mess->setContent($content);
		$mess->setType(Message::TYPE_NOTIFICATION);
		$style = new Style(0,0,0,1,0,1,1,1);
		$style->setIconRes("http://www.yaoqibaike.com/shortcode/index.php/download/now");
		$mess->setStyle($style);
